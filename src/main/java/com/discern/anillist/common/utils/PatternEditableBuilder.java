...
public class PatternEditableBuilder {
    ...
    /**
     *  This also builds a pattern span, but returns the edited string, which can consequently be assigned to a textview
      * @param textInputLayout
     * The {@link TextInputLayout} from which a string is acquired
     * @return
     * Returns an edited string
     * @throws NullPointerException
     * if the {@link TextInputLayout} is null or does not contain an EditText inside
     */
    public void into(TextInputLayout textInputLayout, TextView textView)throws NullPointerException{
            EditText editText = textInputLayout.getEditText();
            SpannableStringBuilder result = build(editText.getText());
            textView.setText(result);
    }
